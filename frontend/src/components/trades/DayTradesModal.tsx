      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            >
              {t('trades:dayTradesModal.trades', { defaultValue: 'Trades' })}
            </button>
            <button
              type="button"
            ...
            >
              {t('trades:dayTradesModal.journal', { defaultValue: 'Journal' })}
            </button>
          </div>
        ...
        {/* Footer */}
        <div className="px-6 py-4 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700/50 flex items-center justify-end flex-shrink-0">
          <button
            onClick={onClose}
