...
const NavigationMenu: React.FC<NavigationMenuProps> = ({
  ...
  const managementItems: NavItemConfig[] = [
    ...
    {
      id: 'session-replay',
      label: t('navigation:sessionReplay', { defaultValue: 'Replay session' }),
      icon: (
        <svg fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      visible: true,
      disabled: isLocked('session-replay'),
      badgeText: isLocked('session-replay') ? premiumBadge : undefined,
    },
    {
      id: 'daily-journal',
    ...
    },
    {
      ...
      label: t('navigation:journalQuestions', { defaultValue: 'Questions du jour' }),
      icon: (
        <svg fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {
      id: 'trading-activity',
      label: t('navigation:tradingActivity', { defaultValue: 'Rentabilité activité' }),
      icon: (
        <svg fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      visible: true,
      disabled: isLocked('trading-activity'),
      badgeText: isLocked('trading-activity') ? premiumBadge : undefined,
    },
    {
      id: 'goals',
  ...
  const strategiesItems: NavItemConfig[] = [
    ...
    {
      id: 'backtest-journal',
      label: t('navigation:backtestJournal', { defaultValue: 'Journal de backtest' }),
      icon: (
        <svg fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path
            strokeLinecap="round"
      ...
      visible: true,
      disabled: isLocked('backtest-journal'),
      badgeText: isLocked('backtest-journal') ? premiumBadge : undefined,
    },
    {
      id: 'market-replay',
      label: t('navigation:marketReplay', { defaultValue: 'Market Replay' }),
      icon: (
        <svg fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      visible: true,
      disabled: isLocked('market-replay'),
      badgeText: isLocked('market-replay') ? premiumBadge : undefined,
    },
  ];
