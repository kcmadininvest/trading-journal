      ...
      <div className="w-full">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 mb-6">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">⏰ Performance par Heure (Nuage de Points)</h2>
            <div className="h-80">
              {chartData ? (
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">📊 Corrélation P/L vs Nombre de Trades</h2>
            <div className="h-80">
              {correlationData?.correlation_data ? (
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">📈 Performance par Heure (Barres)</h2>
            <div className="h-80">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-xl font-semibold text-gray-900">📉 Graphique de Drawdown</h2>
              <Tooltip 
                content={
                  <div>
